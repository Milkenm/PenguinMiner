...
namespace PenguinMiner
{
	...
	public class GlobalHotKey : IDisposable
	{
		...
		public bool RegisterHotKey(string aKeyGestureString, Action aAction)
		{
			KeyGestureConverter c = new KeyGestureConverter();
			KeyGesture aKeyGesture = (KeyGesture)c.ConvertFrom(aKeyGestureString);
			return this.RegisterHotKey(aKeyGesture.Modifiers, aKeyGesture.Key, aAction);
		}

		public bool RegisterHotKey(ModifierKeys aModifier, Key aKey, Action aAction)
		{
